...
int main(int argc, char* argv[])
{
	...
	//SystODEs Quadrotor(0.02, 0.0, 5.0, 9, 11, 0, 10, 2, 200); // valores inicio simulacion
	SystODEs Quadrotor(0.02, 0.0, 5.0, 9, 11, 0, 10, 4, 2000);

	double dblTemporal;
	int iMetodo = 3;	// 1 : Euler linear interpolation
	                    // 2 : Euler forward information
	                    // 3 : Euler backward information
	int iGridPoints;
	int iOutFrecuency = 0;
